...
namespace myspace
{
	...
	public:
		...
		//add in 14
		//virtual std::vector<std::vector<type1>> function9(std::vector<type1> num1, std::vector<type1> num2, type1 k) = 0;
		//add in 15
		virtual type1 function10(std::vector<type1> nums) = 0;
	public:
		int a;
		int b;
		std::list<type3> mylist;          //flag 0
		std::vector<type3> myvector;      //flag 1
		std::multimap<type3, type4> mymap;//flag 2
	};
